...
@Component({
  selector: 'app-findbyedtres',
  standalone: true,
  imports: [FormsModule, NgFor],
  templateUrl: './findbyedtres.component.html',
  styleUrl: './findbyedtres.component.css'
})
export class FindbyedtresComponent {
  ...
  constructor(private route:ActivatedRoute,
    ...
    this.edt.idEducationDegreeType = this.route.snapshot.params['idedtype'];
  }
  ...
  ngOnInit(){
    ...
    this.route.params.subscribe(params => {
      //dico che il parametro 'phone' è = a quello nuovo che ho definito sopra
      this.edt.idEducationDegreeType = +params['idedtype'];

      //adesso invochiamo nuovamente la richiesta per farci restituire la lista dei Candidati
      this.candidateSer.getCandidateByIdEdType(this.edt.idEducationDegreeType).subscribe((data:Candidate[]) => {
