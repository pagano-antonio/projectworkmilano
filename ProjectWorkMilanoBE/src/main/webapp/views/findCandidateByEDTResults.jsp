...
<body>
	<div class="container">
		<h1>CANDIDATE</h1>
		<h2>Candidate By Education Degree Type: Results</h2>

		<h3>
			You looked for Candidates with this Education Degree Type:
			...
			<c:forEach var="can" items="${candidatesEDTResults}">
				<tr>
					...
					<td>
						...
						<form
							action="${pageContext.request.contextPath}/skill/ricercaSkillPerIdCandidate"
							method="Get">
							<input type="hidden" name="idCandidate"
								value="${can.idCandidate}">
						...
						<form
							action="${pageContext.request.contextPath}/JobInterviewCtr/findJobInterviewByIdCandidate"
							method="Post">
							<input type="hidden" name="idCandidate"
								value="${can.idCandidate}">
