...
<div class="container">
<h1>JOB OFFER</h1> 
<h2>Find Job Offer By Start Date End End Date</h2>

<form action="${pageContext.request.contextPath}/JobOfferCtr/preFindJobOfferByStartDateAndEndDate" method="post">
	
		 
		<label for="startDate"><strong>INSERT START DATE:</strong></label>
		<input type="Date" id="startDate" name="startDate">
		<label for="endDate"><strong>INSERT END DATE:</strong></label>
