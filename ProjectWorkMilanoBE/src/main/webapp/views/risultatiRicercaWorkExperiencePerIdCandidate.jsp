			...
			<tbody>
				<c:forEach var="workExperience" items="${workExperienceList}">
					<tr>
						...
						<td>
							<form
								action="${pageContext.request.contextPath}/wk/updateWorkExperienceForm"
								method="Get">
								<input type="hidden" name="idWorkExperience"
									value="${workExperience.idWorkExperience}">
								<button type="submit">UPDATE</button>
							</form>
							<form action="${pageContext.request.contextPath}/wk/deleteWork"
								method="Get">
								<input type="hidden" name="idWorkExperience"
									value="${workExperience.idWorkExperience}">
