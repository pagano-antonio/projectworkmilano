...
<body>
	<div class="container">
		...
		<form
			action="${pageContext.request.contextPath}/candidate/findCandidateByPhone">
			<label for="phone">Insert Phone Number:</label> <br> <input
				type="number" id="phone" name="phone"> <br> <input
				type="submit" value="Find Candidate">
		</form>
	</div>
</body>
</html>