...
<button><a style="text-decoration: none; color: inherit" href="${pageContext.request.contextPath}/JobOfferCtr/preInsertJobOffer">Inserisci un'offerta di lavoro</a></button>
</li>
<hr style="border-color: #000000">

<li>
<h3>RICERCA JOB OFFER BY ID</h3>
<button><a style="text-decoration: none; color: inherit" href="${pageContext.request.contextPath}/JobOfferCtr/preInsertIdJobOffer">Inserisci l'id da cercare</a></button>
</li>
<hr style="border-color: #000000">
...
<button><a style="text-decoration: none; color: inherit" href="${pageContext.request.contextPath}/JobOfferCtr/preInsertIdCompanyClient">Inserisci l'Id da cercare</a></button>
</li>
<hr style="border-color: #000000">
