...
<body style="background-color: #afc1d6">
    ...
    <h1>GESTIONE SKILL</h1>

<ul>

<li>
<h3>INSERIMENTO SKILL</h3>
<a href="${pageContext.request.contextPath}/skill/preInsertSkill" style="text-decoration: none; color: inherit"><button>Inserisci una skill</button></a>
<hr style="border-color: #000000">
</li>
